...
\textbf{SAE stability and universality.} Lan et al.~\cite{lan2024universality} showed SAE feature spaces are similar only up to rotation (shared subspace, not identical features); Leask et al.~\cite{leask2025canonical} argued SAEs ``do not find canonical units of analysis.'' This motivates our matched-stability metric: we expect only a shared subspace, not identical features.
