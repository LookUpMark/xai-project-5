...
- **⚠️ Discrepanza vocabolario:** il markdown del notebook (celle 5, 13, 15) cita "**310 termini / 310 vocab embeddings**" — **stale** (pre-rebuild multi-centroid). Il vocab reale è **508** (`vocabulary.json` + `text_vocab_embeddings.pt` allineati, verificato in run: `Vocabulary: 508 terms, embeddings [508, 512]`). I conteggi sono corretti (usa gli embedding reali a 508 righe); solo il testo descrittivo è da aggiornare.
