...
| source | sae-baseline |
| tag | baseline |
| output dir | /home/marcantoniolopez/Documenti/github/xai-project-5/results/iu_xray/concept_organization_baseline |
| n_clusters | None |
...
| metric | value |
|-------|-------|
| n_concepts_active | 80 |
| n_clusters | 9 |
| mean_cluster_size | 8.89 |
| silhouette_cosine | 0.09426344931125641 |
| redundancy_reduction | 1.527 |
...
- sha256(explanations) [sample_explanations.json]: `388407f22ab1e8e6`
...
- sha256(concept_names) [concept_names.json]: `d7631df1dc50212e`
