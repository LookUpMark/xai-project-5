"""
00_build_vocab.py — Build the medical vocabulary (RadLex or MeSH).
...
Usage:
    python scripts/00_build_vocab.py                       # active dataset
    python scripts/00_build_vocab.py --dataset iu_xray --topk 300
    python scripts/00_build_vocab.py --dataset rocov2
"""
import argparse
import sys
