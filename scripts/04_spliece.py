"""04_spliece.py — orchestrate the full SPLiCE (Path B) sparse decomposition pipeline.
...
Usage:
    python scripts/04_spliece.py                              # standard, full
    python scripts/04_spliece.py --no-gap-correction         # skip modality gap correction
    python scripts/04_spliece.py --k 64 --tag high-k         # custom k with isolation
    python scripts/04_spliece.py --analyze                   # run vocabulary coverage analysis
"""
