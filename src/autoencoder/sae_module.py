...
class SAEManager:
    ...
    def train(
        ...
        trainSAE(
            ...
            device=device,
            autocast_dtype=torch.float32,  # F-016: force float32 everywhere — small dataset,
            # and matches the committed MPS-float32 models for cross-device reproducibility
